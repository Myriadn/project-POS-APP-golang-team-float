...
func seedPermission(db *gorm.DB) error {
	permissions := []entity.Permission{
		...
		{ID: 16, Code: "reservation-read", Description: "Melihat daftar dan detail reservasi"},
		{ID: 17, Code: "reservation-create", Description: "Menambahkan reservasi baru"},
		{ID: 18, Code: "reservation-update", Description: "Mengedit reservasi baru"},
		{ID: 19, Code: "order-read", Description: "melihat daftar order "},
		{ID: 20, Code: "order-create", Description: "menambahkan order baru"},
		{ID: 21, Code: "order-update", Description: "mengedit order"},
		{ID: 22, Code: "order-delete", Description: "menghapus order"},
		{ID: 23, Code: "table-available", Description: "melihat kursi yang kosong"},
		{ID: 24, Code: "payment", Description: "membayar order"},
	}
